...
"""
Модуль использует упрощённый парсинг текста,
скопированного из интерфейса Мешка.

Парсинг основан на фиксированных позициях строк, 
поэтому может ломаться при изменении структуры страницы. 

Не является универсальным решением.
Реализован для упрощенной автоматизации.

В будущем переписать под BeautifulSoup.
"""
